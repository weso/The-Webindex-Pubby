...
public class CONF {
	...
	public static final Property webResourcePrefix = m.createProperty(NS
			+ "webResourcePrefix");
	public static final Property fixUnescapedCharacters = m.createProperty(NS
	...
	public static final Property redirectRDFRequestsToEndpoint = m
			.createProperty(NS + "redirectRDFRequestsToEndpoint");
